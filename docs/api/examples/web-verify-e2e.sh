#!/usr/bin/env bash
#
# OpenSMS Verify on the CONSUMER web app — end-to-end check.
#
...
echo "OpenSMS Verify (web app) → $BASE"
echo
...
# classic SMS-pumping destination, so OpenSMS Verify declines it — but a real
