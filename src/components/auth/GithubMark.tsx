/**
 * The GitHub mark, inlined as SVG (same rationale as GoogleMark: the one
 * screen that has to work should not fetch its icons). Monochrome per
 * GitHub's logo usage guidance on dark surfaces.
 */
