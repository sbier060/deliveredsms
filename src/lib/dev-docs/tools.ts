...
export const AGENT_TOOLS: AgentTool[] = [
  {
    ...
    lead: 'mcp',
    pitch:
      "Connect the OpenSMS MCP server and Claude can send texts, run phone verification, and buy numbers as native tool calls — no glue code.",
  },
  {
    slug: 'claude-code',
    name: 'Claude Code',
    ...
    lead: 'skills',
    pitch:
      "Install the OpenSMS skills once and Claude Code ships SMS and OTP features against the real API — sandbox-first, with the gotchas already encoded.",
  },
  {
    slug: 'cursor',
    name: 'Cursor',
    ...
    lead: 'mcp',
    pitch:
      "Add OpenSMS to Cursor's MCP config and the agent tab can send test messages and wire verification flows while you watch the diff.",
  },
  {
    slug: 'codex',
    name: 'Codex',
    ...
    lead: 'skills',
    pitch:
      "Codex reads SKILL.md files — give it OpenSMS's and it stops hand-rolling OTP over raw SMS and uses the verify primitive instead.",
  },
  {
    slug: 'devin',
    name: 'Devin',
    ...
    lead: 'skills',
    pitch:
      "Point Devin at the OpenSMS skills and long-running tasks like 'add SMS 2FA' resolve against a real sandbox it can test end to end.",
  },
  {
    slug: 'copilot',
    name: 'GitHub Copilot',
    ...
    lead: 'skills',
    pitch:
      "Copilot's agent mode picks up OpenSMS skills from your repo, so generated SMS code matches the API instead of hallucinating one.",
  },
];
