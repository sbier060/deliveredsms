// Pure, dependency-free HTML template for the OpenSMS developer welcome
...
<html lang="en">
  <head>
    ...
    <title>Your OpenSMS sandbox is live</title>
          ...
          <table role="presentation" width="560" cellpadding="0" cellspacing="0" style="max-width: 560px; width: 100%;">
            ...
            <tr>
              <td style="padding-top: 20px; font-family: ${fontStack}; color: #C9C6BF; font-size: 15px; line-height: 1.65;">
                ${greeting}<br /><br />
                Your OpenSMS account is ready. We minted a test key ending in
            ...
            <tr>
              <td style="padding-top: 40px; border-top: 1px solid #1F1E1C; margin-top: 24px; font-family: ${fontStack}; color: #918E86; font-size: 12px; line-height: 1.6;">
                Block Apps LLC · You received this because you created a OpenSMS account.
              </td>
            </tr>
          </table>
        </td>
