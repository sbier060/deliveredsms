...
- Competitor comparison last checked: ${COMPETITORS_CHECKED_ON}; details at https://resms.com/pricing
- 10DLC registration is included in the phone number price.
- Full docs: https://resms.com/docs/llms-full.txt
`;
